...
{
    public class VBLContactDTO : BaseObjectDto
    {
        public VBLContactDTO()
        {
        ...
        public virtual VBLApplicationDTO Application { get; set; }

        public string Forename => SearchContact?.Forename;
        public string Surname => SearchContact?.Surname;
        public string NationalInsuranceNumber => SearchContact?.NationalInsuranceNumber;
        public DateTime? DateOfBirth => SearchContact?.DateOfBirth;

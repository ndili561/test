...
-- =============================================
CREATE PROCEDURE MutualExchangeAccepted
...
BEGIN
   ...
   --get the current CI for applicantA/propertyB
   --update this CI with CIStatusA
   ...
   --insert the CI for applicantB/propertyA
   ...
   --mark both applications as rehoused
   UPDATE dbo.VBLApplications SET ApplicationStatusID = 3 WHERE ApplicationId IN (@applicationIdA,@applicationIdB)
